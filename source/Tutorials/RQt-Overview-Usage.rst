...
* `ROS 1 documentation <http://wiki.ros.org/rqt>`__.
* Brief overview of RQt (from `an intern completion blog post <http://web.archive.org/web/20130518142837/http://www.willowgarage.com/blog/2012/10/21/ros-gui>`__).
